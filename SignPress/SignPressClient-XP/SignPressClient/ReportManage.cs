...
namespace SignPressClient
{
    public partial class ReportManage : Form
    {
        ...
        {
            ComboboxItem[] item ={
               new ComboboxItem("界河航道养护工程","1"),
               new ComboboxItem("内河航道养护工程","2"),
               new ComboboxItem("应急抢通工程","3"),
               new ComboboxItem("例会项目工程","4"),
                                };
            ...
            //this.CategoryId.SelectedIndex = 0;
            //this.Category.SelectedIndex = 0;

            // 后两个如果打开有性能损失
            //this.SelectedCategory.SelectedIndex = 0;
            //this.CateId.SelectedIndex = 0;
