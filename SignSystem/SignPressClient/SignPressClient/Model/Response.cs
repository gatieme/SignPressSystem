...
//内河
        INSERT_CONTRACT_TEMPLATE_INSIDE_SUCCESS,       //添加内河模板成功

        QUERY_CONTRACT_TEMPLATE_SUCCESS,         //查询模板成功
//内河
        QUERY_CONTRACT_TEMPLATE_INSIDE_SUCCESS,         //查询内河模板成功

        QUERY_CONTRACT_TEMPLATE_ALL_SUCCESS,         //查询不同类型模板成功


        GET_CONTRACT_TEMPLATE_SUCCESS,          //获取特定模板成功
//内河
        GET_CONTRACT_TEMPLATE_INSIDE_SUCCESS,          //获取内河特定模板成功

        GET_CONTRACT_TEMPLATE_JHLX_SUCCESS,          //获取界河例行特定模板成功
