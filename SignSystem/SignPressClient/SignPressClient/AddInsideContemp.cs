...
{
    public partial class AddInsideContemp : Form
    {
        SignSocketClient _sc;
        int Type;
        public AddInsideContemp()
        {
            InitializeComponent();
        }
        ...
        #region 数据加载
        private void AddInsideContemp_Load(object sender, EventArgs e)
        {
            ...
            //绑定部门信息
            BindDepartment(UserHelper.DepList);

            if (Type==10)
            {
                this.label3.Visible = true;
                this.Sign4Level.SelectedIndex = -1;
                this.Sign5Level.SelectedIndex = 4;
                this.Sign6Level.SelectedIndex = 5;
                this.Sign7Level.SelectedIndex = 6;
                this.Sign8Level.SelectedIndex = 7;
            }
        ...
        //绑定员工信息
        private List<Employee> BindEmployee(int departmentID)           
        {
        ...
        //绑定控件人员信息
        private void BindEmployeeControl(ComboBox comboBox, List<Employee> list)    
        {
        ...
        private void Column6_Validated(object sender, EventArgs e)
        {
            if (this.Column5.Text.Trim() == "")
            {
