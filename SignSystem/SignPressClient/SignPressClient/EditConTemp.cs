    ...
    public partial class EditConTemp : Form
    {
        ...
        private  void EditConTemp_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.Sign11.Text = temp.SignDatas[10].SignInfo.ToString();
                this.Sign12.Text = temp.SignDatas[11].SignInfo.ToString();
                ...
                this.SignDep9.SelectedValue = temp.SignDatas[8].SignEmployee.Department.Id;
                this.SignDep10.SelectedValue = temp.SignDatas[9].SignEmployee.Department.Id;
                this.SignDep11.SelectedValue = temp.SignDatas[10].SignEmployee.Department.Id;
                this.SignDep12.SelectedValue = temp.SignDatas[11].SignEmployee.Department.Id;
                ...
                this.SignPer9.SelectedValue = temp.SignDatas[8].SignEmployee.Id;
                this.SignPer10.SelectedValue = temp.SignDatas[9].SignEmployee.Id;
                this.SignPer11.SelectedValue = temp.SignDatas[10].SignEmployee.Id;
                this.SignPer12.SelectedValue = temp.SignDatas[11].SignEmployee.Id;
                ...
                this.Sign9Level.SelectedItem = temp.SignDatas[8].SignLevel.ToString();
                this.Sign10Level.SelectedItem = temp.SignDatas[9].SignLevel.ToString();
                this.Sign11Level.SelectedItem = temp.SignDatas[10].SignLevel.ToString();
                this.Sign12Level.SelectedItem = temp.SignDatas[11].SignLevel.ToString();
                ...
                this.View9.SelectedIndex = temp.SignDatas[8].CanView;
                this.View10.SelectedIndex = temp.SignDatas[9].CanView;
                this.View11.SelectedIndex = temp.SignDatas[10].CanView;
                this.View12.SelectedIndex = temp.SignDatas[11].CanView;
                ...
                this.Download9.SelectedIndex = temp.SignDatas[8].CanDownload;
                this.Download10.SelectedIndex = temp.SignDatas[9].CanDownload;
                this.Download11.SelectedIndex = temp.SignDatas[10].CanDownload;
                this.Download12.SelectedIndex = temp.SignDatas[11].CanDownload;
        ...
        private bool CheckIntegrity()
        {
           ...
           || this.Sign10Level.SelectedItem.ToString() == "请选择签字顺序")
            {
                MessageBox.Show("请将签字人10的信息填写完整", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
