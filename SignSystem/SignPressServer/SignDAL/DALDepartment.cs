...
namespace SignPressServer.SignDAL
{
    ...
    public class DALSDepartment : DALDepartment
    {
        ...
        /// 查询部门信息的信息串
        /// </summary>
        private const String QUERY_SDEPARTMENT_STR = @"SELECT id, name, shortcall, canboundary, caninland FROM `department` ORDER BY id";
        ...
        /// <param name="employee"></param>
        /// <returns></returns>
        private const String INSERT_SDEPARTMENT_STR = @"INSERT INTO `department` (`name`, `shortcall`, `canboundary`, `caninland`) VALUES (@Name, @ShortCall, @CanBoundary, @CanInland)";
        ...
        /// 修改部门名称的信息串
        /// </summary>
        private const String MODIFY_SDEPARTMENT_ID_STR = @"UPDATE `department` SET `name` = @Name, `shortcall` = @ShortCall, `canboundary` = @CanBoundary, `caninland` = @CanInland  WHERE (`id` = @Id)";
...
//2016-4-23注释掉
    ...
    public class DALHSDepartment : DALSDepartment
    {
        ...
        private const String QUERY_HSDEPARTMENT_STR = @"SELECT id, name, shortcall, canboundary, caninland, highdepid FROM `department` ORDER BY id";
        ...
        private const String GET_HSDEPARTMENT_BY_ID_STR = @"SELECT id, name, shortcall, canboundary, caninland, highdepid FROM `department` WHERE (id = @departmentId)";
        ...
        ///  modify by gatieme @ 2016-05-12 21:43 新的需求中没有应急和例会, 只需支持界河和内河
        ...
        private static String QUERY_SUB_HSDEPARTMENT_STR = @"SELECT id, name, shortcall, canboundary, caninland, highdepid FROM `department` WHERE (highdepid = @HigherDepartmentId) AND (highdepid != id)";
        /// <summary>
        /// 查询当前部门的二级部门信息
        /// </summary>
