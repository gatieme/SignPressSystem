...
//内河
        INSERT_CONTRACT_TEMPLATE_INSIDE_REQUEST,    //添加内河模板
        QUERY_CONTRACT_TEMPLATE_REQUEST,      //查询模板
//内河
        QUERY_CONTRACT_TEMPLATE_INSIDE_REQUEST,      //查询内河模板

        QUERY_CONTRACT_TEMPLATE_All_REQUEST,      //查询不同类型模板

        GET_CONTRACT_TEMPLATE_REQUEST,       //获取特定模板
//内河
        GET_CONTRACT_TEMPLATE_INSIDE_REQUEST,       //获取内河特定模板

        GET_CONTRACT_TEMPLATE_JHLX_REQUEST,       //获取界河例行特定模板
