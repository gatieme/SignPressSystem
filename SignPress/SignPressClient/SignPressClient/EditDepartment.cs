...
namespace SignPressClient
{
    public partial class EditDepartment : Form
    {
        ...
        private void EditDepartment_Load(object sender, EventArgs e)
        {
            ...
            if (this.m_sdepartment.CanEmergency == 1)
            {
                this.CanEmergency.Checked = true;
            }

            if (this.m_sdepartment.CanRegular == 1)
            {
        ...
        private void ModifyDepartment_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                {
                    this.m_sdepartment.CanEmergency = 1;
                }
                else
                {
                    this.m_sdepartment.CanEmergency = 0;
                }

                if (this.CanRegular.Checked)
                {
                    this.m_sdepartment.CanRegular = 1;
                }
                else
                {
                    this.m_sdepartment.CanRegular = 0;
                }
