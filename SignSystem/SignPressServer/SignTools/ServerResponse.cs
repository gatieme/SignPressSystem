...
//2016-4-18增加插入内河模版
        INSERT_CONTRACT_TEMPLATE_INSIDE_SUCCESS,
        INSERT_CONTRACT_TEMPLATE_INSIDE_FAILED,
...
//2016-4-18内河会签单查询
        QUERY_CONTRACT_TEMPLATE_INSIDE_SUCCESS,
        QUERY_CONTRACT_TEMPLATE_INSIDE_FAILED,
//2016-4-20所有不同类型会签单查询
        QUERY_CONTRACT_TEMPLATE_ALL_SUCCESS,
        QUERY_CONTRACT_TEMPLATE_ALL_FAILED,

        GET_CONTRACT_TEMPLATE_SUCCESS,
        GET_CONTRACT_TEMPLATE_FAILED,
//2016-4-20
        GET_CONTRACT_TEMPLATE_INSIDE_SUCCESS,
        GET_CONTRACT_TEMPLATE_INSIDE_FAILED,

        GET_CONTRACT_TEMPLATE_JHLX_SUCCESS,
        GET_CONTRACT_TEMPLATE_JHLX_FAILED,
