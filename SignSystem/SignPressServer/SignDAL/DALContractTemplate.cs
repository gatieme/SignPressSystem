...
namespace SignPressServer.SignDAL
{
    ...
    class DALContractTemplate
    {
        ...
        /// 插入内河会签单模版信息串
        /// </summary>
        private const String INSERT_CONTRACT_TEMPLATE_STR = @"INSERT INTO `contemp` (`name`,  `createdate`,  `type`,
...
//2016-4-23 增加界河例行
        ...
        /// 插入会签单模版信息串
        /// </summary>
        private const String INSERT_CONTRACT_TEMPLATE_JHL_STR = @"INSERT INTO `contemp` (`name`,  `createdate`,`type`,
                                                                                     `column1`, `column2`, `column3`, `column4`, `column5`, `column6`,
                                                                                     `signinfo1`, `signinfo2`, `signinfo3`, `signinfo4`, `signinfo5`, `signinfo6`, `signinfo7`, `signinfo8`,`signinfo9`,`signinfo10`,   
                                                                                     `signid1`, `signid2`, `signid3`, `signid4`, `signid5`, `signid6`, `signid7`, `signid8`,`signid9`,`signid10`,
                                                                                     `signlevel1`, `signlevel2`, `signlevel3`, `signlevel4`, `signlevel5`, `signlevel6`, `signlevel7`, `signlevel8`,`signlevel9`,`signlevel10`,
                                                                                     `canview1`, `canview2`, `canview3`, `canview4`, `canview5`, `canview6`, `canview7`, `canview8`,`canview9`,`canview10`,
                                                                                     `candownload1`, `candownload2`, `candownload3`, `candownload4`, `candownload5`, `candownload6`, `candownload7`, `candownload8`, `candownload9`, `candownload10`)
                                                              VALUES (@Name, @CreateDate,@Type,
                                                                      @Column_1, @Column_2, @Column_3, @Column_4, @Column_5, @Column_6, 
                                                                      @SignInfo_1, @SignInfo_2, @SignInfo_3, @SignInfo_4, @SignInfo_5, @SignInfo_6, @SignInfo_7, @SignInfo_8, @SignInfo_9, @SignInfo_10, 
                                                                      @SignId_1, @SignId_2, @SignId_3, @SignId_4, @SignId_5, @SignId_6, @SignId_7, @SignId_8,@SignId_9, @SignId_10,
                                                                      @SignLevel_1, @SignLevel_2, @SignLevel_3, @SignLevel_4, @SignLevel_5, @SignLevel_6, @SignLevel_7, @SignLevel_8,@SignLevel_9, @SignLevel_10,
                                                                      @CanView_1, @CanView_2, @CanView_3, @CanView_4, @CanView_5, @CanView_6, @CanView_7, @CanView_8,@CanView_9, @CanView_10,
                                                                      @CanDownload_1, @CanDownload_2, @CanDownload_3, @CanDownload_4, @CanDownload_5, @CanDownload_6, @CanDownload_7, @CanDownload_8, @CanDownload_9, @CanDownload_10)";
//2016-4-23 增加界河专项
        /// <summary>
        /// 插入会签单模版信息串
        /// </summary>
        private const String INSERT_CONTRACT_TEMPLATE_JHZ_STR = @"INSERT INTO `contemp` (`name`,  `createdate`,`type`,
                                                                                     `column1`, `column2`, `column3`, `column4`, `column5`, 
                                                                                     `signinfo1`, `signinfo2`, `signinfo3`, `signinfo4`, `signinfo5`, `signinfo6`, `signinfo7`, `signinfo8`,`signinfo9`,`signinfo10`,  `signinfo11`,`signinfo12`,  
                                                                                     `signid1`, `signid2`, `signid3`, `signid4`, `signid5`, `signid6`, `signid7`, `signid8`,`signid9`,`signid10`,`signid11`,`signid12`,
                                                                                     `signlevel1`, `signlevel2`, `signlevel3`, `signlevel4`, `signlevel5`, `signlevel6`, `signlevel7`, `signlevel8`,`signlevel9`,`signlevel10`,`signlevel11`,`signlevel12`,
                                                                                     `canview1`, `canview2`, `canview3`, `canview4`, `canview5`, `canview6`, `canview7`, `canview8`,`canview9`,`canview10`,`canview11`,`canview12`,
                                                                                     `candownload1`, `candownload2`, `candownload3`, `candownload4`, `candownload5`, `candownload6`, `candownload7`, `candownload8`, `candownload9`, `candownload10`, `candownload11`, `candownload12`)
                                                              VALUES (@Name, @CreateDate,@Type,
                                                                      @Column_1, @Column_2, @Column_3, @Column_4, @Column_5, 
                                                                      @SignInfo_1, @SignInfo_2, @SignInfo_3, @SignInfo_4, @SignInfo_5, @SignInfo_6, @SignInfo_7, @SignInfo_8, @SignInfo_9, @SignInfo_10,  @SignInfo_11, @SignInfo_12, 
                                                                      @SignId_1, @SignId_2, @SignId_3, @SignId_4, @SignId_5, @SignId_6, @SignId_7, @SignId_8,@SignId_9, @SignId_10,@SignId_11, @SignId_12,
                                                                      @SignLevel_1, @SignLevel_2, @SignLevel_3, @SignLevel_4, @SignLevel_5, @SignLevel_6, @SignLevel_7, @SignLevel_8,@SignLevel_9, @SignLevel_10,@SignLevel_11, @SignLevel_12,
                                                                      @CanView_1, @CanView_2, @CanView_3, @CanView_4, @CanView_5, @CanView_6, @CanView_7, @CanView_8,@CanView_9, @CanView_10,@CanView_11, @CanView_12,
                                                                      @CanDownload_1, @CanDownload_2, @CanDownload_3, @CanDownload_4, @CanDownload_5, @CanDownload_6, @CanDownload_7, @CanDownload_8, @CanDownload_9, @CanDownload_10, @CanDownload_11, @CanDownload_12)";
        //2016-4-18增加插入内河会签单模版信息串
        /// <summary>
        /// 插入内河会签单模版信息串
        /// </summary>
        private const String INSERT_CONTRACT_TEMPLATE_INSIDE_STR = @"INSERT INTO `contempinside` (`name`,  `createdate`,
                                                                                     `column1`, `column2`, `column3`, `column4`, `column5`, `column6`,
                                                                                     `signinfo1`, `signinfo2`, `signinfo3`, `signinfo4`, `signinfo5`, `signinfo6`, `signinfo7`, `signinfo8`, 
                                                                                     `signid1`, `signid2`, `signid3`, `signid4`, `signid5`, `signid6`, `signid7`, `signid8`,
                                                                                     `signlevel1`, `signlevel2`, `signlevel3`, `signlevel4`, `signlevel5`, `signlevel6`, `signlevel7`, `signlevel8`,
        ...
        private const String MODIFY_CONTRACT_TEMPLATE_STR = @"UPDATE `contemp` 
                                                        SET `name` = @Name, `column1` = @Column_1, `column2` = @Column_2, `column3` = @Column_3, `column4` = @Column_4, `column5` = @Column_5, 
                                                             `signinfo1` = @SignInfo_1, `signinfo2` = @SignInfo_2, `signinfo3` = @SignInfo_3, `signinfo4` = @SignInfo_4, `signinfo5` = @SignInfo_5, `signinfo6` = @SignInfo_6, `signinfo7` = @SignInfo_7, `signinfo8` = @SignInfo_8, `signinfo9` = @SignInfo_9, `signinfo10` = @SignInfo_10, `signinfo11` = @SignInfo_11, `signinfo12` = @SignInfo_12,
                                                             `signid1` = @SignId_1, `signid2` = @SignId_2, `signid3` = @SignId_3, `signid4` = @SignId_4, `signid5` = @SignId_5, `signid6` = @SignId_6, `signid7` = @SignId_7, `signid8` = @SignId_8, `signid9` = @SignId_9, `signid10` = @SignId_10, `signid11` = @SignId_11, `signid12` = @SignId_12,
                                                             `signlevel1` = @SignLevel_1, `signlevel2` = @SignLevel_2, `signlevel3` = @SignLevel_3, `signlevel4` = @SignLevel_4, `signlevel5` = @SignLevel_5, `signlevel6` = @SignLevel_6, `signlevel7` = @SignLevel_7, `signlevel8` = @SignLevel_8, `signlevel9` = @SignLevel_9, `signlevel10` = @SignLevel_10, `signlevel11` = @SignLevel_11, `signlevel12` = @SignLevel_12,
                                                             `canview1` = @CanView_1, `canview2` = @CanView_2, `canview3` = @CanView_3, `canview4` = @CanView_4, `canview5` = @CanView_5, `canview6` = @CanView_6, `canview7` = @CanView_7, `canview8` = @CanView_8,`canview9` = @CanView_9, `canview10` = @CanView_10, `canview11` = @CanView_11, `canview12` = @CanView_12,
                                                             `candownload1` = @CanDownload_1, `candownload2` = @CanDownload_2, `candownload3` = @CanDownload_3, `candownload4` = @CanDownload_4, `candownload5` = @CanDownload_5, `candownload6` = @CanDownload_6, `candownload7` = @CanDownload_7, `candownload8` = @CanDownload_8, `candownload9` = @CanDownload_9,`candownload10` = @CanDownload_10,`candownload11` = @CanDownload_11, `candownload12` = @CanDownload_12
                                                        WHERE (`id` = @Id)";
        private const String MODIFY_CONTRACT_TEMPLATE_NH_STR = @"UPDATE `contemp` 
                                                        SET `name` = @Name, `column1` = @Column_1, `column2` = @Column_2, `column3` = @Column_3, `column4` = @Column_4, `column5` = @Column_5, `column6` = @Column_6, 
                                                        ...
                                                        WHERE (`id` = @Id)";
        private const String MODIFY_CONTRACT_TEMPLATE_JHLX_STR = @"UPDATE `contemp` 
                                                        SET `name` = @Name, `column1` = @Column_1, `column2` = @Column_2, `column3` = @Column_3, `column4` = @Column_4, `column5` = @Column_5, `column6` = @Column_6, 
                                                             `signinfo1` = @SignInfo_1, `signinfo2` = @SignInfo_2, `signinfo3` = @SignInfo_3, `signinfo4` = @SignInfo_4, `signinfo5` = @SignInfo_5, `signinfo6` = @SignInfo_6, `signinfo7` = @SignInfo_7, `signinfo8` = @SignInfo_8, `signinfo9` = @SignInfo_9, `signinfo10` = @SignInfo_10,  
                                                             `signid1` = @SignId_1, `signid2` = @SignId_2, `signid3` = @SignId_3, `signid4` = @SignId_4, `signid5` = @SignId_5, `signid6` = @SignId_6, `signid7` = @SignId_7, `signid8` = @SignId_8, `signid9` = @SignId_9, `signid10` = @SignId_10, 
                                                             `signlevel1` = @SignLevel_1, `signlevel2` = @SignLevel_2, `signlevel3` = @SignLevel_3, `signlevel4` = @SignLevel_4, `signlevel5` = @SignLevel_5, `signlevel6` = @SignLevel_6, `signlevel7` = @SignLevel_7, `signlevel8` = @SignLevel_8, `signlevel9` = @SignLevel_9, `signlevel10` = @SignLevel_10,
                                                             `canview1` = @CanView_1, `canview2` = @CanView_2, `canview3` = @CanView_3, `canview4` = @CanView_4, `canview5` = @CanView_5, `canview6` = @CanView_6, `canview7` = @CanView_7, `canview8` = @CanView_8,`canview9` = @CanView_9, `canview10` = @CanView_10, 
                                                             `candownload1` = @CanDownload_1, `candownload2` = @CanDownload_2, `candownload3` = @CanDownload_3, `candownload4` = @CanDownload_4, `candownload5` = @CanDownload_5, `candownload6` = @CanDownload_6, `candownload7` = @CanDownload_7, `candownload8` = @CanDownload_8, `candownload9` = @CanDownload_9,`candownload10` = @CanDownload_10
                                                        WHERE (`id` = @Id)";
        ...
        /// 获取界河专项会签单模版信息串
        /// </summary>
        private const String GET_CONTRACT_TEMPLATE_JHZ_ID_STR = @"SELECT c.id id, c.name name, c.createdate createdate,
                                                                  ...
                                                                  c.signlevel1 signlevel1, c.signlevel2, c.signlevel2, c.signlevel3, signlevel3, c.signlevel4 signlevel4, c.signlevel5 signlevel5, c.signlevel6 signlevel6, c.signlevel7 signlevel7, c.signlevel8 signlevel8,c.signlevel9 signlevel9, c.signlevel10 signlevel10, c.signlevel11 signlevel11, c.signlevel12 signlevel12,
...
//2016-4-23 修改为全在contemp中查询模版信息
        private const String GET_CONTRACT_TEMPLATE_INSIDE_ID_STR = @"SELECT c.id id, c.name name, c.createdate createdate,
                                                                  c.column1 column1, c.column2 column2, c.column3 column3, c.column4 column4, c.column5 column5, c.column6 column6,
...
//2016-4-29 界河例行
        private const String GET_CONTRACT_TEMPLATE_JHLX_ID_STR = @"SELECT c.id id, c.name name, c.createdate createdate,
                                                                  c.column1 column1, c.column2 column2, c.column3 column3, c.column4 column4, c.column5 column5, c.column6 column6,
...
//2016-04-18
        ...
        /// 查询内河会签单模版的信息串
        /// </summary>
        private const String QUERY_CONTRACT_TEMPLATE_INSIDE_STR = @"SELECT id, name, createdate, type FROM `contemp` ORDER BY id";
//2016-04-20
        /// <summary>
        /// 查询所界河例行签单模版的信息串
        /// </summary>
        private const String QUERY_CONTRACT_TEMPLATE_JHLX_STR = @"SELECT id, name ,createdate FROM `contemp` ORDER BY id"; 
        #endregion

//2016-4-23  插入会签单就要判断type是什么类型  不同类型的插入sql语句不同
        #region 插入会签单模版信息
        /// <summary>
        /// 插入员工信息
        /// </summary>
        ...
        public static bool InsertContractTemplate(ContractTemplate conTemp)
        {
            ...
            try
            {
                ...
                if (conTemp.Type==10||conTemp.Type==11)
                {
                    //进行内河模版的插入  6个栏目 8个签字人
                ...
                if (conTemp.Type==20)
                {
                    //进行界河例行模版的插入  6个栏目 10个签字人
                    cmd.CommandText = INSERT_CONTRACT_TEMPLATE_JHL_STR;
                    columncount = 6;
                    signcount = 10;
                }
                ...
                if (conTemp.Type==21)
                {
                    //进行界河专项模版的插入   5个栏目12个签字人
                    cmd.CommandText = INSERT_CONTRACT_TEMPLATE_JHZ_STR;
                    columncount = 5;
                    signcount = 12;
                }
                ...
                cmd.Parameters.AddWithValue("@Type", conTemp.Type);
                ...
                for (int cnt = 0; cnt < signcount; cnt++)
                {
...
//2016-4-18 增加插入内河会签单模版信息处理模块    没用了
        #region 插入内河会签单模版信息
        /// <summary>
        /// 插入内河模版信息
        /// </summary>
        /// <param name="conTemp">待插入的会签单模版</param>
        /// <returns></returns>
        public static bool InsertContractTemplate_INSIDE(ContractTemplateInside conTemp)
        {
            MySqlConnection con = DBTools.GetMySqlConnection();
            MySqlCommand cmd;
            ...
            try
            {
                ...
                cmd = con.CreateCommand();
                cmd.CommandText = INSERT_CONTRACT_TEMPLATE_INSIDE_STR;
                ...
                if (count == 1)     //  插入成功后的受影响行数为1
                {
                    Console.WriteLine("插入内河会签单模版成功");
                    return true;
                }
                else
                {
                    Console.WriteLine("插入内河会签单模版失败");
                    return false;
                }
            }
            catch (Exception)
        ...
        public static bool ModifyContractTemplate(ContractTemplate conTemp)
        {
            ...
            try
            {
                ...
                if (conTemp.Type==10||conTemp.Type==11)
                {
                    columncount = 6;
                    signcount = 8;
                    cmd.CommandText = MODIFY_CONTRACT_TEMPLATE_NH_STR;
                }
                //界河例行
                if (conTemp.Type == 20)
                {
                    columncount = 6;
                    signcount = 10;
                    cmd.CommandText = MODIFY_CONTRACT_TEMPLATE_JHLX_STR;
                }
                //界河专项
                if (conTemp.Type == 21)
                {
...
//2016-04-18查询内河会签单请求
//2016-4-23修改为查询全部模版信息在contemp表中    仅查询id 模版名称  和  创建时间
        #region 查询会签单模版的信息
        public static List<ContractTemplate> QueryContractTemplateInside()
        {
            MySqlConnection con = DBTools.GetMySqlConnection();
            MySqlCommand cmd;
            ...
            try
            {
                ...
                cmd = con.CreateCommand();
                //查询 id 模版名称 模版代码 创建时间
                cmd.CommandText = QUERY_CONTRACT_TEMPLATE_INSIDE_STR;
                ...
                while (sqlRead.Read())
                {
                    ...
                    conTemp.TempId = int.Parse(sqlRead["id"].ToString());
                    conTemp.Name = sqlRead["name"].ToString();
                    conTemp.Type = int.Parse(sqlRead["type"].ToString());
                    conTemp.CreateDate = sqlRead["createdate"].ToString();
                    conTemps.Add(conTemp);
                }
...
//2016-04-20查询所有会签单请求
        #region 查询所有会签单模版的信息
        public static List<ContractTemplate> QueryContractTemplateJHLX()
        {
            MySqlConnection con = DBTools.GetMySqlConnection();
            MySqlCommand cmd;
            ...
            try
            {
                ...
                cmd.CommandText = QUERY_CONTRACT_TEMPLATE_JHLX_STR;
        ...
        #region 获取界河专项会签单模版的信息
        /// <summary>
        /// 获取到编号为conTempId的界河专项模版的信息
        /// </summary>
        /// <param name="conTempId"></param>
        /// <returns></returns>
        public static ContractTemplate GetContractTemplate(int conTempId)
        {
            ...
            try
            {
                ...
                cmd.CommandText = GET_CONTRACT_TEMPLATE_JHZ_ID_STR;
...
//2016-4-20
//2016-4-24  修改为在contemp表获取全部信息  故返回的类型都是 ContractTemplate
        /// <summary>
        /// 获取到编号为conTempId的模版的信息
        /// </summary>
        /// <param name="conTempId"></param>
        /// <returns></returns>
        public static ContractTemplate GetContractTemplateInside(int conTempId)
        {
            MySqlConnection con = DBTools.GetMySqlConnection();
            MySqlCommand cmd;
            ...
            try
            {
                ...
                cmd.CommandText = GET_CONTRACT_TEMPLATE_INSIDE_ID_STR;
                cmd.Parameters.AddWithValue("@Id", conTempId);                         // 员工编号
        ...
        public static ContractTemplate GetContractTemplateJHLX(int conTempId)
        {
            MySqlConnection con = DBTools.GetMySqlConnection();
            MySqlCommand cmd;
            ...
            try
            {
                ...
                cmd.CommandText = GET_CONTRACT_TEMPLATE_JHLX_ID_STR;
                cmd.Parameters.AddWithValue("@Id", conTempId);                         // 员工编号
